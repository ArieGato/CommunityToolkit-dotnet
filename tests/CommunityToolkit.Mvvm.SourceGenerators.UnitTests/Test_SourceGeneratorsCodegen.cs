...
public partial class Test_SourceGeneratorsCodegen
{
    ...
    [TestMethod]
    public void RelayCommandWithOnExecutionFailedExceptionHandler_GeneratesSubscription()
    {
        string source = """
            using System;
            using CommunityToolkit.Mvvm.Input;
            ...
            {
                [RelayCommand(OnExecutionFailed = nameof(OnTestFailed))]
                private void Test()
                {
                }
        ...
        string result = """
            ...
            namespace MyApp
            {
                ...
                partial class MyViewModel
                {
                    ...
                    [global::System.CodeDom.Compiler.GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", <ASSEMBLY_VERSION>)]
                    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                    public global::CommunityToolkit.Mvvm.Input.IRelayCommand TestCommand
                    {
                        get
                        {
                            if (testCommand is null)
                            {
                                global::CommunityToolkit.Mvvm.Input.RelayCommand command = new global::CommunityToolkit.Mvvm.Input.RelayCommand(new global::System.Action(Test));
                                command.ExecutionFailed += (s, e) => OnTestFailed(e.Exception);
                                testCommand = command;
                            }
    ...
    [TestMethod]
    public void RelayCommandWithOnExecutionFailedExceptionHandlerAndSuppressExceptions_GeneratesSeededSubscription()
    {
        string source = """
            using System;
            using CommunityToolkit.Mvvm.Input;
            ...
            public partial class MyViewModel
            {
                [RelayCommand(OnExecutionFailed = nameof(OnTestFailed), SuppressExceptions = true)]
                private void Test()
                {
                }
        ...
        // The handler cannot observe the event args, so the seed is written after the call
        string result = """
            // <auto-generated/>
            #pragma warning disable
            #nullable enable
    ...
    [TestMethod]
    public void RelayCommandWithOnExecutionFailedEventArgsHandlerAndSuppressExceptions_GeneratesSeededSubscription()
    {
        string source = """
            using CommunityToolkit.Mvvm.Input;
            ...
            public partial class MyViewModel
            {
                ...
                private void OnTestFailed(RelayCommandExceptionEventArgs e)
                {
                }
            }
            """;

        // The seed is written before the call here, so that the handler can still override it either way
        string result = """
            // <auto-generated/>
            #pragma warning disable
            #nullable enable
    ...
    [TestMethod]
    public void RelayCommandWithOnExecutionFailedEventArgsHandler_GeneratesSubscription()
    {
        string source = """
            using CommunityToolkit.Mvvm.Input;
                ...
                partial class MyViewModel
                {
                    ...
                    public global::CommunityToolkit.Mvvm.Input.IRelayCommand TestCommand
                    {
                        get
                        {
                            ...
                            {
                                global::CommunityToolkit.Mvvm.Input.RelayCommand command = new global::CommunityToolkit.Mvvm.Input.RelayCommand(new global::System.Action(Test));
                                command.ExecutionFailed += (s, e) => OnTestFailed(e);
                                testCommand = command;
                            }
    ...
    [TestMethod]
    public void GenericRelayCommandWithOnExecutionFailedEventArgsHandler_GeneratesSubscription()
    {
        string source = """
            using CommunityToolkit.Mvvm.Input;
        ...
        string result = """
            ...
            namespace MyApp
            {
                ...
                partial class MyViewModel
                {
                    /// <summary>The backing field for <see cref="TestCommand"/>.</summary>
                    [global::System.CodeDom.Compiler.GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", <ASSEMBLY_VERSION>)]
                    private global::CommunityToolkit.Mvvm.Input.RelayCommand<string>? testCommand;
                    /// <summary>Gets an <see cref="global::CommunityToolkit.Mvvm.Input.IRelayCommand{T}"/> instance wrapping <see cref="Test"/>.</summary>
                    [global::System.CodeDom.Compiler.GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", <ASSEMBLY_VERSION>)]
                    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                    public global::CommunityToolkit.Mvvm.Input.IRelayCommand<string> TestCommand
                    {
                        get
                        {
                            if (testCommand is null)
                            {
                                global::CommunityToolkit.Mvvm.Input.RelayCommand<string> command = new global::CommunityToolkit.Mvvm.Input.RelayCommand<string>(new global::System.Action<string>(Test));
                                command.ExecutionFailed += (s, e) => OnTestFailed(e);
                                testCommand = command;
                            }
    ...
    [TestMethod]
    public void RelayCommandWithOnExecutionFailedMemberNamedCommand_RenamesEmittedLocal()
    {
        // The getter builds the command into a local before publishing it to the backing field. If a member
        // the emitted code also has to bind to is itself named "command", that local would shadow it, so the
        // generator renames the local instead. Here the handler is named "command", so the subscription call
        // has to keep resolving to the method and not to the local.
        string source = """
            using System;
            using CommunityToolkit.Mvvm.Input;
            ...
            public partial class MyViewModel
            {
                [RelayCommand(OnExecutionFailed = nameof(command))]
                private void Test()
                {
                }

                private void command(Exception exception)
                {
                }
            }
            """;
                ...
                partial class MyViewModel
                {
                    ...
                    public global::CommunityToolkit.Mvvm.Input.IRelayCommand TestCommand
                    {
                        get
                        {
                            if (testCommand is null)
                            {
                                global::CommunityToolkit.Mvvm.Input.RelayCommand _command = new global::CommunityToolkit.Mvvm.Input.RelayCommand(new global::System.Action(Test));
                                _command.ExecutionFailed += (s, e) => command(e.Exception);
    ...
    [TestMethod]
    public void GenericRelayCommandWithOnExecutionFailedGenericEventArgsHandlerAndSuppressExceptions_GeneratesSeededSubscription()
    {
        string source = """
            using CommunityToolkit.Mvvm.Input;
            ...
            public partial class MyViewModel
            {
                ...
                private void OnTestFailed(RelayCommandExceptionEventArgs<string> e)
                {
                }
            }
            """;

        // The seed goes before the call for every event args shape, the generic one included, so a handler
        // reading the strongly typed parameter can still override the decision for that fault
        string result = """
            // <auto-generated/>
            #pragma warning disable
            #nullable enable
    ...
    [TestMethod]
    public void GenericRelayCommandWithOnExecutionFailedGenericEventArgsHandler_GeneratesSubscription()
    {
        string source = """
            using CommunityToolkit.Mvvm.Input;
    ...
    [TestMethod]
    public void AsyncRelayCommandWithOnExecutionFailedHandler_GeneratesSubscription()
    {
        string source = """
            using System;
        ...
        string result = """
            ...
            namespace MyApp
            {
                ...
                partial class MyViewModel
                {
                    ...
                    /// <summary>Gets an <see cref="global::CommunityToolkit.Mvvm.Input.IAsyncRelayCommand"/> instance wrapping <see cref="TestAsync"/>.</summary>
                    [global::System.CodeDom.Compiler.GeneratedCode("CommunityToolkit.Mvvm.SourceGenerators.RelayCommandGenerator", <ASSEMBLY_VERSION>)]
                    [global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
                    public global::CommunityToolkit.Mvvm.Input.IAsyncRelayCommand TestCommand
                    {
                        get
                        {
                            if (testCommand is null)
                            {
                                global::CommunityToolkit.Mvvm.Input.AsyncRelayCommand command = new global::CommunityToolkit.Mvvm.Input.AsyncRelayCommand(new global::System.Func<global::System.Threading.Tasks.Task>(TestAsync));
                                command.ExecutionFailed += (s, e) => OnTestFailed(e.Exception);
                                testCommand = command;
                            }
        ...
        VerifyGenerateSources(source, new[] { new RelayCommandGenerator() }, ("MyApp.MyViewModel.TestAsync.g.cs", result));
    }
